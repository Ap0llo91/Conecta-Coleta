  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Como Funciona a Coleta Seletiva</Text>
      </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.descriptionText}>
            A coleta seletiva em Recife funciona com separação de materiais recicláveis dos não recicláveis.
          </Text>
          ...
          <View style={styles.legendRow}>
            ...
            <View>
              ...
              <Text style={styles.legendSubtitle}>Papel, papelão, plástico, vidro, metal</Text>
            </View>
          </View>
          ...
          <View style={styles.legendRow}>
            ...
            <View>
              ...
              <Text style={styles.legendSubtitle}>Resíduos não recicláveis e orgânicos</Text>
            </View>
          </View>
        </View>

        {/* Card: Horários de Coleta */}
        <View style={styles.card}>
          <Text style={styles.sectionTitleGreen}>Horários de Coleta</Text>
          
          <View style={styles.scheduleRow}>
            <Text style={styles.scheduleLabel}>Lixo Comum</Text>
            <Text style={styles.scheduleDays}>2ª, 4ª, 6ª</Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.scheduleRow}>
            <Text style={styles.scheduleLabel}>Coleta Seletiva</Text>
            <Text style={styles.scheduleDays}>3ª, 5ª</Text>
          </View>
          
          <Text style={styles.scheduleNote}>
            * Horários variam por bairro. Consulte o mapa para sua região.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.gridContainer}>
            <GridItem icon="file-document-outline" label="Papel e Papelão" color="#5D4037" /> 
            <GridItem icon="bottle-soda-classic-outline" label="Plástico" color="#E53935" />
            <GridItem icon="glass-wine" label="Vidro" color="#43A047" />
            {/* CORREÇÃO: Trocado 'can' por 'trash-can-outline' */}
            <GridItem icon="trash-can-outline" label="Metal/Latas" color="#FBC02D" />
          </View>
        </View>
...
const ListItem = ({ text }) => (
  <View style={styles.listItem}>
    <Ionicons name="close" size={20} color="#E53935" style={{ marginRight: 10 }} />
...
const styles = StyleSheet.create({
  ...
  scheduleDays: { fontSize: 16, fontWeight: 'bold', color: '#00A859' },
  divider: { height: 1, backgroundColor: '#EEE', marginVertical: 5 },
  scheduleNote: { fontSize: 12, color: '#888', marginTop: 15, fontStyle: 'italic' },
  ...
  gridLabel: { marginTop: 10, fontSize: 14, color: '#555', textAlign: 'center' },
